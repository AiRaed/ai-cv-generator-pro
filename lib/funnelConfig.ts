...
> = {
  en: {
    ...
    paywallTrustLine: 'Secure checkout by Stripe',
    lockTooltip: 'Preview ended — pay to continue editing & download.',
  ...
  ar: {
    ...
    paywallTrustLine: 'دفع آمن عبر Stripe',
    lockTooltip: 'انتهت المعاينة — ادفع للمتابعة والتنزيل.',
